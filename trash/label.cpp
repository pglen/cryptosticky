...
{
	//P2N("Setting CLabel font size to %d\r\n", nSize);
...

{
	...
	CFont* oldFont = dc.SelectObject(&m_font);
	m_txtsize = dc.GetTextExtent(m_text);
	
	//P2N("Sizeing cx=%d cy=%d\r\n", m_txtsize.cx, m_txtsize.cy);

	SetWindowPos(NULL, 0, 0, m_txtsize.cx + 2, m_txtsize.cy + 2, SWP_NOMOVE | SWP_NOZORDER );
...
{
	//P2N("void CLabel::PreSubclassWindow()%p\r\n", this);
	CStatic::PreSubclassWindow();
	ModifyStyleEx(WS_EX_STATICEDGE | WS_EX_DLGMODALFRAME, 0);
