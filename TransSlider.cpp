...
//					pResult - value depends on the current drawing state.
{
	...
	//P2N(_T("CTransSlider::OnCustomDraw\r\n"));
...

{
	...
	//P2N(_T("Drawchannel -- Focus=%d \r\n"), focus);

	//P2N(_T("DrawChannel p=%p l=%d t=%d\r\n"), this, wrect.left, wrect.top);
...
{
	//P2N(_T("CTransSlider::OnEraseBkgnd\r\n"));
...
{
	P2N(_T("CTransSlider::OnMouseWheel %d\r\n"), zDelta);
...
{
	//P2N(_T("CTransSlider::OnMouseMove\r\n"));
	int newpos = GetPos();
...

{
	...
	P2N(_T("CSliderCtrl::OnKeyDown %d\r\n"), GetPos());
...
{
	//P2N(_T("CTransSlider::OnScroll %d %d\r\n"), opcode, pos);
